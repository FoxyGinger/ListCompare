...
class TestListCompareAverage:
    ...
    FIRST_GREATER_STR = "Первый список имеет большее среднее значение"
    SECOND_GREATER_STR = "Второй список имеет большее среднее значение"
    ...
    def test_int_lists_first_greater(self):
        ...
        Проверка что срдеднее первого списка больше.
        """
    ...
    def test_int_lists_second_greater(self):
        """
        Целочисленные списки.
        Проверка что срдеднее второго списка больше.
        """
